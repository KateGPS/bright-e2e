...
public class AppColors {
    public static final String errorColor = "#995e00";
    public static final String scansTextColorDarkTheme = "#f2f4f5";
    ...
    public static final String buttonsPrimaryColor = "#07737d";
